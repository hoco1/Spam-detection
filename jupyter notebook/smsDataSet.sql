-- CREATE DATABASE SpamSMS
-- USE SpamSMS
-- DROP TABLE SMS
CREATE TABLE SMS(
   [label] VARCHAR(4) NOT NULL ,
   [sms]   VARCHAR(910) NOT NULL
);
INSERT INTO SMS(label,sms) VALUES
...
,('ham','Wen u miss someone, the person is definitely special for u..... But if the person is so special, why to miss them, just Keep-in-touch')
...
,('ham','Speak only when you feel your words are better than the silence...')
...
,('ham','Life is nothing wen v get everything')
...
,('ham','Its Ur luck to Love someone. Its Ur fortune to Love the one who Loves U. But, its a miracle to Love a person who can''t Love anyone except U...')
